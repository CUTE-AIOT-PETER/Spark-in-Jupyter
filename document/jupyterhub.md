...
```bash
docker run -p 8000:8000 -itd --name jupyterhub -v ./jupyterhub_config.py:/etc/jupyterhub/jupyterhub_config.py jupyterhub/jupyterhub jupyterhub -f /etc/jupyterhub/jupyterhub_config.py
```
